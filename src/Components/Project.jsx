    ...
    <section className='flex justify-center bg-fy dark:bg-darkFy py-6 lg:py-16'>
       <div className='flex-col space-y-6 md:space-y-10 lg:space-y-12'>
            ...
            <div className='flex flex-col md:flex-row  bg-white dark:bg-[#2B2727] md:space-x-4 lg:space-x-12 drop-shadow-lg rounded-lg'>
                <img className="flex rounded-md md:rounded-none md:rounded-s-md lg:rounded-s-lg w-[220px] md:w-[240px] lg:w-[360px] h-[220px] md:h-[260px] lg:h-[360px]" src="src/assets/projects_1.png" alt="" />
                <div className='grid  md:pr-6 lg:pr-10 items-center'>
                    ...
                    <div className='space-x-5'>
                        <a className="tetx-[#120B39] dark:text-fy font-medium text-[16px] underline" href="\">View Site</a>
                        <a className="tetx-[#120B39] dark:text-fy font-medium text-[16px] underline" href="\">Github</a>
                    </div>
                </div>
            </div>
            <div></div>
