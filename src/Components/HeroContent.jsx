  ...
  return (
    <section className=' flex relative  w-[955px] h-[375.89px] justify-between top-[148px] left-[200px] '>
      <div className ='grid w-[528.88px] h-[375.89px]  top-[46px]'>
        ...
        <button className=' grid border-1 border-solid border-btn bg-white w-[127px] h-[52px] py-3 pr-5 pl-3 rounded-md gap-[10px] '>
          <div className='flex gap-[10px]'>
            <IoLogoGithub className=' text-btn  place-content-center w-[26px] h-[26.26px]'/>
            <p className='text-btn font-int text-lg leading-7 font-medium text-left tracking-normal  h-[26.26px]'>Github</p>
          </div>
        </button>

        <button className=' grid border-1 border-solid border-btn bg-white w-[127px] h-[52px] py-3 pr-5 pl-3 rounded-md gap-[10px] '>
          <div className='flex gap-[10px]'>
            <FaLinkedinIn  className=' text-btn  place-content-center w-[26px] h-[26.26px]'/>
            <p className='text-btn font-int text-lg leading-7 font-medium text-left tracking-normal  h-[26.26px]'>Linkedin</p>
          </div>
        </button>
        </div>
      </div>
