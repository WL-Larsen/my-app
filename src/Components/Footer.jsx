  ...
  return (
    <footer className='flex bg:white dark:bg-[#252128] justify-center py-6 lg:py-16'>
      <div className='flex flex-col justify-center  space-y-1 md:space-y-3 lg:space-y-6'>
        ...
        <p className='text-center text-[#120B39] dark:text-white  text-xs md:text-base lg:text-xl w-36  md:w-72 lg:w-96 h-12 md:h-16 lg:h-16 pl-5 md:pl-0 lg:pl-5'>{response?.sendMeP}</p>
