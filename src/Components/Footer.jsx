  ...
  return (
    <footer className='flex bg:white dark:bg-[#252128] justify-center py-6 lg:py-16'>
      <div className='flex flex-col justify-center  space-y-1 md:space-y-3 lg:space-y-6'>
        <h2 className='text-center text-[#4731D3] dark:text-[#8F88FF] font-bold text-xl md:text-3xl lg:text-5xl '>Send me a message!</h2>
        <p className='text-center text-[#120B39] dark:text-white  text-xs md:text-base lg:text-xl w-36  md:w-72 lg:w-96 h-12 md:h-16 lg:h-16 pl-5 md:pl-0 lg:pl-5'>Got a question or proposal, or just want to say hello? Go ahead.</p>
